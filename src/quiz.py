...
class QuizDialog(tk.Toplevel):
    def __init__(self, parent, noun):
        ...
        tk.Label(self, text=self.question, font=("Arial", 13, "bold"),
                 bg=BG_COLOR, fg=TEXT_COLOR, wraplength=380, justify="center").pack(pady=15)
        ...
        tk.Button(self, text="Submit", command=self.check_answer,
